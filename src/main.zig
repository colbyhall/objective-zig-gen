    ...
    switch (args) {
        .parsed => |result| {
                    ...
                    // Merge typedefs
                    {
                        ...
                        while (iter.next()) |it| {
                            if (!a.typedefs.contains(it.key_ptr.*)) {
                                try a.typedefs.put(gpa, it.key_ptr.*, it.value_ptr.*);
                            }
                        }
                    }
                    ...
                    // Merge structs
                    {
                        ...
                        while (iter.next()) |it| {
                            if (!a.structs.contains(it.key_ptr.*)) {
                                try a.structs.put(gpa, it.key_ptr.*, it.value_ptr.*);
                            }
                        }
                    }
                    ...
                    // Merge unions
                    {
                        ...
                        while (iter.next()) |it| {
                            if (!a.unions.contains(it.key_ptr.*)) {
                                try a.unions.put(gpa, it.key_ptr.*, it.value_ptr.*);
                            }
                        }
                    }
                    ...
                    // Merge enums
                    {
                        ...
                        while (iter.next()) |it| {
                            if (!a.enums.contains(it.key_ptr.*)) {
                                try a.enums.put(gpa, it.key_ptr.*, it.value_ptr.*);
                            }
                        }
                    }
                    ...
                    // Merge interfaces
                    {
                        ...
                        while (iter.next()) |it| {
                            if (!a.interfaces.contains(it.key_ptr.*)) {
                                try a.interfaces.put(gpa, it.key_ptr.*, it.value_ptr.*);
                            }
                        }
                    }
                    ...
                    // Merge protocols
                    {
                        ...
                        while (iter.next()) |it| {
                            if (!a.protocols.contains(it.key_ptr.*)) {
                                try a.protocols.put(gpa, it.key_ptr.*, it.value_ptr.*);
                            }
                        }
                    }
                }
            ...
            // Generate the root file that includes the runtime and all the frameworks.
            {
                ...
                var writer = root_file.writerStreaming(&buffer);
                _ = try writer.interface.write("// THIS FILE IS AUTOGENERATED. MODIFICATIONS WILL NOT BE MAINTAINED.\n\n");
                _ = try writer.interface.write("pub usingnamespace @import(\"objc.zig\"); // Export the objective c runtime to root. \n");
